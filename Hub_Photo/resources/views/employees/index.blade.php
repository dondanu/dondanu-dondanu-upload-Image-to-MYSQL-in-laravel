...
<div style="height: 100%; display: flex; justify-content: center; align-items: center; font-family: Arial, sans-serif;">
    <div style="width: 90%; max-width: 1100px; background: rgba(255, 255, 255, 0.8); border-radius: 20px; box-shadow: 0px 6px 15px rgba(0, 0, 0, 0.2); overflow: hidden; position: relative; z-index: 2;">
        ...
        <div style="padding: 30px; font-family: 'Roboto', sans-serif; font-size: 16px;">
            <a href="{{ url('/employee/create') }}" class="btn btn-success btn-sm" title="Add New Contact" style="display: inline-block; background-color: #28a745; color: #fff; padding: 10px 15px; border-radius: 5px; text-decoration: none; font-weight: bold; margin-bottom: 20px; transition: background-color 0.3s ease;">
